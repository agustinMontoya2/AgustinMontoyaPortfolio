...
function Contact() {
  ...
  return (
    <div className="h-screen w-full bg-[#FFFFFF] flex items-center justify-evenly flex-col dark:bg-[#121212]">
        <h2 className="text-[34px] sm:text-[44px] font-extrabold text-[#121212] font-montserrat mt-12 dark:text-[#FFFFFF]">Contactate conmigo</h2>
      <div className="w-5/6 h-5/6 sm:w-4/6 sm:h-4/6 bg-[#E0E0E0] rounded-3xl dark:bg-[#343434] flex flex-col justify-evenly">
...
<div className="flex flex-col items-center h-2/3">
    <form onSubmit={handleSubmit} className="w-[100%] flex flex-col items-center justify-evenly h-full">
  <div className="w-[90%]">
  <p className="text-[#121212] font-montserrat font-semibold text-[20px] text-center dark:text-[#FFFFFF]">¿Como te llamas?</p>
      ...
      value={email.name}
        name="name"
        type="text" 
        className="bg-[#F5F5F5] border-[#FFB800] border-[1px] py-2 px-4 rounded-md w-[100%] text-[#121212] dark:bg-[#1a1a1a] dark:text-[#FFFFFF]"
      />
  </div>
  <div className="w-[90%]">
  ...
  <p className="text-[#121212] font-montserrat font-semibold text-[20px] text-center dark:text-[#FFFFFF]">¿Cual es tu mensaje?</p>
      ...
      onChange={handleChange} 
      name="message"
  className="resize-none bg-[#f5f5f5] border border-[#FFB800] text-[#121212] p-2 rounded-md w-[100%] h-32 dark:bg-[#1a1a1a] dark:text-[#FFFFFF]" 
></textarea>
  </div>
  <button 
      type="submit" disabled={loading}
      className="bg-[#FFB800] text-[#121212] py-1 px-6 rounded-md w-[50%] flex justify-center items-center"
    >
